...
## SCADA Applications
### SCADA systems are employed across various industries and industrial sectors for the purposes of monitoring, controlling, and collecting data from processes. Here are some common applications:
...
## SCADA system applications and their main features:
### Asix SCADA:
...
**Destiny -** It is to enable the operator to contact the automation system installed on object
**Role -** Should perform specific tasks abbreviated as MMI (known as HMI) and SCADA
 ### Functions:
 -  Process flow control (automatically or by operator)
 - Visualization of the automated process technological (industrial)
 - Possibility to exchange data with:
	- company IT system
	- spreadsheets
	- databases
